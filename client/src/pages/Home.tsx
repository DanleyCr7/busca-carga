...
const clientLink =
  import.meta.env.VITE_APPSFLYER_CLIENT_ONELINK_URL ||
      ...
      <main>
            ...
            <div>
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                <a
                  ...
                  className="inline-flex items-center justify-center gap-2 rounded-2xl bg-[#1254d8] px-6 py-4 font-bold text-white shadow-lg shadow-blue-700/20"
                >
        ...
        <section id="aplicativo" className="container pb-20">
          <div className="flex flex-col items-start justify-between gap-8 rounded-[2.5rem] bg-[#1254d8] p-8 text-white lg:flex-row lg:items-center lg:p-12">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 rounded-2xl bg-white px-6 py-4 font-bold text-[#1254d8]"
            >
        ...
        >
          <div className="container flex flex-col items-start justify-between gap-7 lg:flex-row lg:items-center">
            ...
            <a
              href={clientLink}
              className="inline-flex items-center gap-2 rounded-2xl border border-slate-300 bg-white px-6 py-4 font-bold"
            >
